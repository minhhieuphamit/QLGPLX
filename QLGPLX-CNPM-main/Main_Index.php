    ...
    if (empty($_SESSION['username'])) {
        if (isset($cookie_name)) {
            if (isset($_COOKIE[$cookie_name])) {
                ...
                if ($result2) {
                    header('location:Main_Index_Login.php');
                    exit;
                }
            }
        }
    }else {
        header('location:Main_HS.php'); //chuyển qua trang đăng nhập thành công
        exit;
    }
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($username == "" || $password == "") {
            ...
            if ($f_user == $username && $f_pass == $password) {
                ...
                header('location:Main_Index_Login.php'); //chuyền qua trang đăng nhập thành công
                exit;
            }else {
            ...
            <div id="module-1" class="header">
                <div class="container">
                    <div id="module-2" class="logo">
                        <a href="Main_Index.php" title="Trang chủ"><img class=" logo-banner" src="./assets/img/logo.png" alt="Logo"></a>
                    </div>
                    <div id="module-3" class="navigation">
                        <ul class="nav">
                            <li><a href="Main_Index.php">Trang Chủ</a></li>
                        </ul>
            ...
            <div id="module-4" class="content">
                <div class="container">
                    <div id="module-5" class="search-driving-license">
                        ...
                        <form name="form1" action="Main_Search.php" onsubmit="return  required()" method="post">
                            ...
                            <input class="btn-send-contact" type="submit" id="btn" value="Tra cứu" name= "submit" style="font-size: 16px;"/></br></br>
                        </form>
                    </div>   
                </div>                                  
            </div>
            ...
            <div id="module-8" class="content">
                <div class="container">
                    <div id="module-9" class="news">
                        <div class="title"><h3 class="news-heading">Tin Tức </h3></div>
